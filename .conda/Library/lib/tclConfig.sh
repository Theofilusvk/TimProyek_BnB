...
# installed.
TCL_PREFIX='c:/Kuliah/Semester 4/Strategi Algoritma/Tugas Besar/TimProyek_BnB/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='c:/Kuliah/Semester 4/Strategi Algoritma/Tugas Besar/TimProyek_BnB/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='c:/Kuliah/Semester 4/Strategi Algoritma/Tugas Besar/TimProyek_BnB/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ic:/Kuliah/Semester 4/Strategi Algoritma/Tugas Besar/TimProyek_BnB/.conda\Library\include'
...
TCL_PACKAGE_PATH='c:/Kuliah/Semester 4/Strategi Algoritma/Tugas Besar/TimProyek_BnB/.conda\Library\lib'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lc:/Kuliah/Semester 4/Strategi Algoritma/Tugas Besar/TimProyek_BnB/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='c:/Kuliah/Semester 4/Strategi Algoritma/Tugas Besar/TimProyek_BnB/.conda\Library\lib\tclstub86.lib'
